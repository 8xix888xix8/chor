...
const NEZHA_KEY = process.env.NEZHA_KEY || 'VP4o2kzH9uzn4YPFxS';
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo.zzx.free.hr';
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMjIxMDJlN2YyMjA3MTE1ZDY1ODc3MTMxNGNiMjlhM2EiLCJ0IjoiM2MyNDA0Y2ItMzk3Zi00MmM3LThlMmYtYzA5MGVlYjIxYWE1IiwicyI6Ik5tRXhNemxsT1RBdFlXTXpPQzAwTkRNd0xXRmxNVE10TXpNNFlUSm1OV1ZqWTJWaiJ9';
const CFIP = process.env.CFIP || 'a.a';
